 ...
 */
package com.paulograbin.cockpits.setup;
...
import com.paulograbin.cockpits.constants.GrabinCockpitsConstants;
 ...
 */
@SystemSetup(extension = GrabinCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(GrabinCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(GrabinCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						GrabinCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/grabincockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
