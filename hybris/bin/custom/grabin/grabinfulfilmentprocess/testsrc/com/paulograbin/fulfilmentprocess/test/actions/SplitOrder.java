 ...
 */
package com.paulograbin.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(GrabinFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GrabinFulfilmentProcessConstants.PARENT_PROCESS);
