...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/grabinstorefront/electronics/en",
						"https://electronics.local:9002/grabinstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/grabinstorefront/electronics/en",
						"https://electronics.local:9002/grabinstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/grabinstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/grabinstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/grabinstorefront/electronics/en",
						"https://electronics.local:9002/grabinstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/grabinstorefront",
						"https://electronics.local:9002/grabinstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/grabinstorefront",
						"https://electronics.local:9002/grabinstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/grabinstorefront/electronics/en",
						"https://electronics.local:9002/grabinstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
