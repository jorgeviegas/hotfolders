 ...
 */
package com.paulograbin.core.constants;

/**
 * Global class for all GrabinCore constants. You can add global constants for your extension into this class.
 */
public final class GrabinCoreConstants extends GeneratedGrabinCoreConstants
{
	public static final String EXTENSIONNAME = "grabincore";


	private GrabinCoreConstants()
	{
		//empty
	}
