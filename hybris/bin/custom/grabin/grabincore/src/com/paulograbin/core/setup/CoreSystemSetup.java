...
public class CoreSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		processCockpit(context, importAccessRights, extensionNames, "reportcockpit",
				"/grabincore/import/cockpits/reportcockpit/reportcockpit-users.impex",
				"/grabincore/import/cockpits/reportcockpit/reportcockpit-access-rights.impex");

		if (extensionNames.contains("mcc"))
		{
			importImpexFile(context, "/grabincore/import/common/mcc-sites-links.impex");
		}
	}
