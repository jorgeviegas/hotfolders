 ...
 */
package com.paulograbin.test.setup;
...
import com.paulograbin.test.constants.GrabinTestConstants;
import com.paulograbin.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GrabinTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/grabintest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/grabintest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/grabintest/import/cstickets.impex");
			...
			importImpexFile(context, "/grabintest/import/csquotes.impex");
		}
	}
}
